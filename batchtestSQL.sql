...
show tables from spring_batch;
show tables from stfptest;
show tables from batchtest;
...
delete from people where person_id = 6;
...
(1, 'example1@example.com', 'John Doe'),
(2, 'example2@example.com', 'Jane Smith'),
(3, 'example3@example.com', 'Michael Johnson');
